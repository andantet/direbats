package net.moddingplayground.direbats.client;
...
import net.moddingplayground.direbats.client.model.DirebatsEntityModelLayers;
import net.moddingplayground.direbats.client.render.entity.DirebatEntityRenderer;
import net.moddingplayground.direbats.client.render.entity.DirebatFangArrowEntityRenderer;
import net.moddingplayground.direbats.entity.DirebatsEntities;
